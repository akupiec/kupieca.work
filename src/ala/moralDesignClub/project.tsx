    ...
    <div class="content">
      ...
      <section id="section2">
        ...
        <div class="noteboxes">
          ...
          <p>
            We embrace innovation in design thinking, pushing the boundaries to
            <strong> create solutions that address societal challenges.</strong>
          </p>
        </div>
        <div class="noteboxes">
          <p>
        ...
        <div class="noteboxes">
          ...
          <p>
            We understand the responsibility that comes with our <strong>creative influence.</strong> Our designs aim to
            foster positive change, addressing social and environmental issues.
          </p>
        </div>
        <div class="noteboxes">
          <p>
      ...
      <section id="section7">
        ...
        <p>
          The stickers not only served as a visual representation of my dedication to sustainable design but also proved
          to be <strong> effective conversation starters</strong>. Engaging with fellow creatives and enthusiasts, these
      ...
      <section id="section9">
        ...
        <div class="noteboxes">
          <h2>Navigating overwhelming challenges</h2>
          <p>
